...
def adjust_results4_isadog(results_dic, dogfile):
  ...
  try:
    ...
    for key in results_dic:
      ...
      # Classifier Label IS image of Dog (e.g. found in dognames_list)
    ...
    print("There was an error when opening the {} file".format(dogfile))
  finally:
    # Close the opened dogfile
    dogname_file.close()
