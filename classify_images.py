...
def classify_images(images_dir, results_dic, model):
    ...
    """
    # Processes each file in the results dictionary
    for key in results_dic:
      ...
      # Extends results dictionary with the label returned by the model 
      # and whether the model correctly classified the image
